...
// IntegrationAwsExternalIDsGetter has a method to return a IntegrationAwsExternalIDInterface.
...
// integrationAwsExternalIDs implements IntegrationAwsExternalIDInterface
type integrationAwsExternalIDs struct {
	client rest.Interface
	ns     string
}

// newIntegrationAwsExternalIDs returns a IntegrationAwsExternalIDs
func newIntegrationAwsExternalIDs(c *CloudV1alpha1Client, namespace string) *integrationAwsExternalIDs {
	return &integrationAwsExternalIDs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *integrationAwsExternalIDs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IntegrationAwsExternalID, err error) {
	result = &v1alpha1.IntegrationAwsExternalID{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *integrationAwsExternalIDs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IntegrationAwsExternalIDList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IntegrationAwsExternalIDList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("integrationawsexternalids").
...
func (c *integrationAwsExternalIDs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *integrationAwsExternalIDs) Create(ctx context.Context, integrationAwsExternalID *v1alpha1.IntegrationAwsExternalID, opts v1.CreateOptions) (result *v1alpha1.IntegrationAwsExternalID, err error) {
	result = &v1alpha1.IntegrationAwsExternalID{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("integrationawsexternalids").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(integrationAwsExternalID).
		Do(ctx).
		Into(result)
	return
}
...
func (c *integrationAwsExternalIDs) Update(ctx context.Context, integrationAwsExternalID *v1alpha1.IntegrationAwsExternalID, opts v1.UpdateOptions) (result *v1alpha1.IntegrationAwsExternalID, err error) {
	result = &v1alpha1.IntegrationAwsExternalID{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("integrationawsexternalids").
		Name(integrationAwsExternalID.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(integrationAwsExternalID).
		Do(ctx).
		Into(result)
...
func (c *integrationAwsExternalIDs) UpdateStatus(ctx context.Context, integrationAwsExternalID *v1alpha1.IntegrationAwsExternalID, opts v1.UpdateOptions) (result *v1alpha1.IntegrationAwsExternalID, err error) {
	result = &v1alpha1.IntegrationAwsExternalID{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("integrationawsexternalids").
...
func (c *integrationAwsExternalIDs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *integrationAwsExternalIDs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *integrationAwsExternalIDs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IntegrationAwsExternalID, err error) {
	result = &v1alpha1.IntegrationAwsExternalID{}
