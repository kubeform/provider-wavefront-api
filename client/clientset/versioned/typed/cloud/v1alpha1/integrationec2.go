...
// IntegrationEc2sGetter has a method to return a IntegrationEc2Interface.
...
// integrationEc2s implements IntegrationEc2Interface
type integrationEc2s struct {
	client rest.Interface
	ns     string
}

// newIntegrationEc2s returns a IntegrationEc2s
func newIntegrationEc2s(c *CloudV1alpha1Client, namespace string) *integrationEc2s {
	return &integrationEc2s{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *integrationEc2s) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IntegrationEc2, err error) {
	result = &v1alpha1.IntegrationEc2{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *integrationEc2s) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IntegrationEc2List, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IntegrationEc2List{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("integrationec2s").
...
func (c *integrationEc2s) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *integrationEc2s) Create(ctx context.Context, integrationEc2 *v1alpha1.IntegrationEc2, opts v1.CreateOptions) (result *v1alpha1.IntegrationEc2, err error) {
	result = &v1alpha1.IntegrationEc2{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("integrationec2s").
...
func (c *integrationEc2s) Update(ctx context.Context, integrationEc2 *v1alpha1.IntegrationEc2, opts v1.UpdateOptions) (result *v1alpha1.IntegrationEc2, err error) {
	result = &v1alpha1.IntegrationEc2{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("integrationec2s").
		Name(integrationEc2.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(integrationEc2).
		Do(ctx).
		Into(result)
...
func (c *integrationEc2s) UpdateStatus(ctx context.Context, integrationEc2 *v1alpha1.IntegrationEc2, opts v1.UpdateOptions) (result *v1alpha1.IntegrationEc2, err error) {
	result = &v1alpha1.IntegrationEc2{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("integrationec2s").
...
func (c *integrationEc2s) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *integrationEc2s) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *integrationEc2s) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IntegrationEc2, err error) {
	result = &v1alpha1.IntegrationEc2{}
