...
// IntegrationTeslasGetter has a method to return a IntegrationTeslaInterface.
...
// integrationTeslas implements IntegrationTeslaInterface
type integrationTeslas struct {
	client rest.Interface
	ns     string
}

// newIntegrationTeslas returns a IntegrationTeslas
func newIntegrationTeslas(c *CloudV1alpha1Client, namespace string) *integrationTeslas {
	return &integrationTeslas{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *integrationTeslas) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IntegrationTesla, err error) {
	result = &v1alpha1.IntegrationTesla{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *integrationTeslas) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IntegrationTeslaList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IntegrationTeslaList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("integrationteslas").
...
func (c *integrationTeslas) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *integrationTeslas) Create(ctx context.Context, integrationTesla *v1alpha1.IntegrationTesla, opts v1.CreateOptions) (result *v1alpha1.IntegrationTesla, err error) {
	result = &v1alpha1.IntegrationTesla{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("integrationteslas").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(integrationTesla).
		Do(ctx).
		Into(result)
	return
}
...
func (c *integrationTeslas) Update(ctx context.Context, integrationTesla *v1alpha1.IntegrationTesla, opts v1.UpdateOptions) (result *v1alpha1.IntegrationTesla, err error) {
	result = &v1alpha1.IntegrationTesla{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("integrationteslas").
		Name(integrationTesla.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(integrationTesla).
		Do(ctx).
		Into(result)
...
func (c *integrationTeslas) UpdateStatus(ctx context.Context, integrationTesla *v1alpha1.IntegrationTesla, opts v1.UpdateOptions) (result *v1alpha1.IntegrationTesla, err error) {
	result = &v1alpha1.IntegrationTesla{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("integrationteslas").
...
func (c *integrationTeslas) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *integrationTeslas) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *integrationTeslas) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IntegrationTesla, err error) {
	result = &v1alpha1.IntegrationTesla{}
