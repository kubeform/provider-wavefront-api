...
type FakeMetrics struct {
	Fake *FakeDerivedV1alpha1
	ns   string
}

var metricsResource = schema.GroupVersionResource{Group: "derived.wavefront.kubeform.com", Version: "v1alpha1", Resource: "metrics"}

var metricsKind = schema.GroupVersionKind{Group: "derived.wavefront.kubeform.com", Version: "v1alpha1", Kind: "Metric"}
