...
type FakeLinks struct {
	Fake *FakeExternalV1alpha1
	ns   string
}

var linksResource = schema.GroupVersionResource{Group: "external.wavefront.kubeform.com", Version: "v1alpha1", Resource: "links"}

var linksKind = schema.GroupVersionKind{Group: "external.wavefront.kubeform.com", Version: "v1alpha1", Kind: "Link"}
