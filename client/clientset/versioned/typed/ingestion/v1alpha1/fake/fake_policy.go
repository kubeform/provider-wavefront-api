...
type FakePolicies struct {
	Fake *FakeIngestionV1alpha1
	ns   string
}

var policiesResource = schema.GroupVersionResource{Group: "ingestion.wavefront.kubeform.com", Version: "v1alpha1", Resource: "policies"}

var policiesKind = schema.GroupVersionKind{Group: "ingestion.wavefront.kubeform.com", Version: "v1alpha1", Kind: "Policy"}
