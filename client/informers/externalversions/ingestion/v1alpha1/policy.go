...
import (
	...
	v1alpha1 "kubeform.dev/provider-wavefront-api/client/listers/ingestion/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IngestionV1alpha1().Policies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IngestionV1alpha1().Policies(namespace).Watch(context.TODO(), options)
			},
		},
		&ingestionv1alpha1.Policy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *policyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ingestionv1alpha1.Policy{}, f.defaultInformer)
}
