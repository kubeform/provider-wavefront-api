...
import (
	...
	v1alpha1 "kubeform.dev/provider-wavefront-api/client/listers/external/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ExternalV1alpha1().Links(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExternalV1alpha1().Links(namespace).Watch(context.TODO(), options)
			},
		},
		&externalv1alpha1.Link{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *linkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&externalv1alpha1.Link{}, f.defaultInformer)
}
