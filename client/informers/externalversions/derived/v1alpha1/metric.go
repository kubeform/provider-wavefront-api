...
import (
	...
	v1alpha1 "kubeform.dev/provider-wavefront-api/client/listers/derived/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DerivedV1alpha1().Metrics(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DerivedV1alpha1().Metrics(namespace).Watch(context.TODO(), options)
			},
		},
		&derivedv1alpha1.Metric{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *metricInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&derivedv1alpha1.Metric{}, f.defaultInformer)
}
